create database paseos_caninos2;
use paseos_caninos2;
...
select Nombre_Perro, Nombre_Dueno from Perro inner join Dueno on DNI_dueno = DNI where Nombre_Dueno like 'Pedro%';

/*Obtener todos los perros que asistieron a la peluquería en 2022*/
select fecha, Nombre_Perro from Historial inner join Perro on Perro = ID_Perro where fecha > '2021-12-31' and fecha < '2022-12-31';
